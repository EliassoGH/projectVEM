...
namespace GaussLobatto
{
    ...
    public:
         ...
         * 
         * @param n 
         * @return const std::pair<std::vector<real>, std::vector<real>>& 
         */
        static const std::pair<std::vector<real>, std::vector<real>> &getCache(unsigned int n);
    };

    /**
     * @brief Function to compute the derivative of the Legendre polynomial of order n
     * 
     * @param n 
     * @param x 
     * @return real 
     */
    inline real legendreDerivative(unsigned int n, real x)
    {
        return (n * x * boost::math::legendre_p(n, x) - n * boost::math::legendre_p(n - 1, x)) / (x * x - 1);
    }

    /**
     * @brief Returns the floor((n-4)/2+1) abscissas of n-points Gauss Lobatto inside (0,1) for the standard interval [-1,1]
     * 
     * @param n 
    ...
    /**
     * @brief Returns the n abscissas and weights of n-points Gauss Lobatto for the standard interval [-1,1]
     * 
     * @param n 
    ...
    /**
     * @brief Method to compute n-points Gauss-Lobatto points and weights on an edge
     * 
     * @param edge 
     * @param n 
     * @return std::pair<std::vector<Point3D>, std::vector<real>> 
     */
...
namespace IntegrationMonomial
{
    ...
    private:
        /**
         * @brief Stores the integrals of the monomials for the faces
         * 
         */
    ...
    public:
        /**
         * @brief Initialize the cache for the whole faces in the mesh
         * 
         * @param mesh 
         * @param order 
         */
        ...
        /**
         * @brief Initialize the cache for a face
         * 
         * @param F 
         * @param order 
         */
        ...
        /**
         * @brief Get the integrals of monomials up to a given order over a face
         * 
         * @param F 
         * @param order 
         * @return std::vector<real>& 
    ...
    /**
     * @brief Integrate a (scaled) 2D or 3D monomial respectively over a non-scaled 2D or 3D domain.
     ...
     * 
     * @tparam DomainType 
     * @tparam d dimension of the space the monomial is embedded in
     * @param N dimension of the domain of integration
     * @param E domain type
     * @param monomial
     * @param O origin of the system, (0,0,0) if not given
     * @param h diameter, 1.0 if not given
     * @param ex first local axis, (1,0,0) if not given
     * @param ey second local axis, (0,1,0) if not given
     * @return real 
     */
    template <typename DomainType, unsigned int d>
    ...
    /**
     * @brief Get a polygon's centroid
     * 
     * @param F 
     * @return Point3D 
     */
    ...
    /**
     * @brief Get a polyhedron's volume
     * 
     * @param P 
     * @return real 
     */
    inline real getPolyhedronVolume(const Polyhedron<Polygon3D> &P)
    {
        return integrateMonomial(3, P, Monomial3D(0, 0, 0, 1.0));
    }

    /**
     * @brief Get a polyhedron's centroid
     * 
     * @param P 
     * @return Point3D 
     */
    inline Point3D getPolyhedronCentroid(const Polyhedron<Polygon3D> &P)
    {
    ...
    // Integrate the restriction on a plane of a monomial embedded in R3 times a monomial embedded in R2
    ...
    // Integrate the restriction on a plane of a monomial embedded in R3 times a polynomial embedded in R2
...
namespace Gauss
{
    ...
    /**
     * @brief Computes the Gauss points and weights for a tetrahedron
     * 
     * @param v1 
     * @param v2 
     * @param v3 
     * @param v4 
     * @param N_ 
     * @return std::vector<std::array<real, 4>> 
     */
    ...
    /**
     * @brief Computes the Gauss points and weights for a polyhedron, exploiting subtetrahedralization
     * 
     * @param P 
     * @param N_ 
     * @return std::vector<std::array<real, 4>> 
    ...
    /**
     * @brief Integrate a generic function over a tetrahedron
     * 
     * @param func 
     * @param v1 
     * @param v2 
    ...
    /**
     * @brief Integrate a generic function over a polyhedron
     * 
     * @param func 
     * @param P 
     * @param N_ 
