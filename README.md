...
# 3D arbitrary order Virtual Element Method for linear elastostatics
## by Elias Pescialli

The program implements the virtual element method of arbitrary order $k$ applied to linear elastostatics in three dimensions.
